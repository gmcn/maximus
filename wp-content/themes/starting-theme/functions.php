...
{
	// product taxonomy
    $products_area_labels = array(
        'name'          => 'Product Category',
        'singular_name' => 'Product Category',
        'menu_name'     => 'Product Category'
    );
    $products_area_args = array(
        'labels'                     => $products_area_labels,
        'hierarchical'               => true,
        'public'                     => true,
        'show_ui'                    => true,
    ...
    register_taxonomy( 'products_category', array( 'products' ), $products_area_args );
}
...
function careers_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Career information page.', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'revisions', 'featured', 'page-attributes' ),
		'hierarchical'          => false,
		'public'                => true,
...
{
	// partners taxonomy
    $partners_area_labels = array(
        'name'          => 'Partner Country',
        'singular_name' => 'Partner Country',
        'menu_name'     => 'Partner Country'
    );
    $partners_area_args = array(
        'labels'                     => $partners_area_labels,
        'hierarchical'               => true,
        'public'                     => true,
        'show_ui'                    => true,
        'show_admin_column'          => true,
...
function case_studies_taxonomies()
{
    ...
    $case_studies_area_labels = array(
        'name'          => 'Case Study Product Type',
        'singular_name' => 'Case Study Product Type',
        'menu_name'     => 'Case Study Product Type'
    );
    $case_studies_area_args = array(
        'labels'                     => $case_studies_area_labels,
        'hierarchical'               => true,
        'public'                     => true,
        'show_ui'                    => true,
        'show_admin_column'          => true,
